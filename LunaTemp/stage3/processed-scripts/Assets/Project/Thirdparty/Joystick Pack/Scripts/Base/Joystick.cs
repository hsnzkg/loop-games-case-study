...
public class Joystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    protected virtual void HandleInput(float magnitude, [Bridge.Ref] Vector2 normalised, [Bridge.Ref] Vector2 radius, Camera cam)
    {
    ...
    protected Vector2 ScreenPointToAnchoredPosition([Bridge.Ref] Vector2 screenPosition)
    {
